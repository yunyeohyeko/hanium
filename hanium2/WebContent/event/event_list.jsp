	...
	<div data-role="page">
		...
		<div data-role="content">
			...
			<div data-role="controlgroup" data-type="horizontal">
				<a href="#" data-role="button" data-theme="b">전체</a> <a href="#"
					data-role="button" data-theme="b">예정</a> <a href="#"
					data-role="button" data-theme="b">진행</a> <a href="#"
					data-role="button" data-theme="b">완료</a>
			</div>
			...
			<ul data-role="listview" data-filter="true"
				...
				<li><a href='event_info.jsp'>
						<h4>국민은행</h4>
						<p>이력서 사진 무료 촬영 이벤트!</p> <span class="ui-li-count">예정</span>
				...
				<li><a href='event_info.jsp'>
						<h4>국민은행</h4>
						<p>이력서 사진 무료 촬영 이벤트!</p> <span class="ui-li-count">완료</span>
						<p class="ui-li-aside">16:00 추첨</p>
				</a></li>
